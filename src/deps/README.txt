This directory contains external source code imported from external projects, from which we build modules in the mho library (modules/). See /src/build/buildscript.sjs for how we we build modules from the code here.
...
- IMPORTANT: cd back into the conductance repo (i.e. deps/ or higher) 
- commit the changes to the conductance repo
